...
import { registerUser, clearAuthStatus } from '../../store/authSlice';
import { Mail, Lock, User, MapPin, AlertCircle, ArrowRight, Eye, EyeOff, UserPlus } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-gray-50 via-gray-100/50 to-blue-50/20 flex items-center justify-center p-5">
      ...
      <SuccessModal 
        ...
        message="Your account has been registered and verified successfully. Welcome to FightFlex!" 
      />

      {/* 6-Digit OTP Modal Dialog */}
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-black text-gray-900">Create New Account</h2>
          <p className="text-gray-500 text-xs font-semibold tracking-widest uppercase mt-1">
            Join FightFlex Today
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  minLength={6}
                  className="w-full rounded-2xl border border-gray-300 bg-gray-50 px-4 py-3.5 pr-12 text-sm text-gray-900 placeholder-gray-400 outline-none transition-all duration-200 focus:border-blue-600 focus:bg-white focus:ring-2 focus:ring-blue-100 font-semibold"
                />
